...
因此，后续论文主表建议使用 v0.4.17。v0.4.19-v0.4.22 可以放在 ablation 或
speed/quality trade-off 表里，用来说明训练预算继续压缩时的质量代价。v0.4.23
说明 conservative VCP 可以稳住质量，但它主要通过少删来降低误删风险，没有带来
明显训练时间收益。

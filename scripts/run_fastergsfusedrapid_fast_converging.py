...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--config-dir', type=Path, default=Path('configs/fastergsfusedrapid_v0_4_8_anysplat_only_18k'))
    parser.add_argument('--suite-name', default='fastergsfusedrapid_v0_4_8_anysplat_only_18k')

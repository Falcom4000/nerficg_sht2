...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--config-dir', type=Path, default=Path('configs/fastergsfusedrapid_v0_4_9_anysplat_only_18k_sh_schedule'))
    parser.add_argument('--suite-name', default='fastergsfusedrapid_v0_4_9_anysplat_only_18k_sh_schedule')

...
namespace rasterization_api = fast_gs::rasterization;
namespace adam_api = fast_gs::adam;
namespace filter3d_api = fast_gs::filter3d;
namespace densification_api = fast_gs::densification;
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("metric_counts", &rasterization_api::metric_counts_wrapper);

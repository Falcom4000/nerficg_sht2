...
class FasterGSBasisRapidModel(BaseModel):
    """Defines FasterGSBasisRapid model."""

    def __init__(self, name: str = None) -> None:
        super().__init__(name)
        self.gaussians: Gaussians | None = None

    def build(self) -> 'FasterGSBasisRapidModel':
        """Builds the model."""
    ...
    def get_ply_dict(self) -> dict[str, np.ndarray | list[str]]:
        ...
        data['comments'] = ['SplatRenderMode: default', 'Generated with NeRFICG/FasterGSBasisRapid']
